...
FILES=(
  "scripts/list-bound-execution-gate-check.sh|scripts/list-bound-execution-gate-check.sh|0755"
  "scripts/list-bound-execution-gate/package.json|scripts/list-bound-execution-gate/package.json|0644"
  "scripts/list-bound-execution-gate/src/cli.js|scripts/list-bound-execution-gate/src/cli.js|0755"
  "scripts/list-bound-execution-gate/src/index.js|scripts/list-bound-execution-gate/src/index.js|0644"
  "scripts/list-bound-execution-gate/src/list-bound-execution-gate.js|scripts/list-bound-execution-gate/src/list-bound-execution-gate.js|0644"
)
