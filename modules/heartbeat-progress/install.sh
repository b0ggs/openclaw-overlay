...
STATE_DIR="$TARGET/.openclaw-overlay/modules/heartbeat-progress"
BACKUP_DIR="$STATE_DIR/backup"
MANIFEST="$STATE_DIR/manifest.tsv"
DIRS_CREATED="$STATE_DIR/dirs-created.txt"

FILES=(
  "scripts/check-heartbeat.py|scripts/check-heartbeat.py|0755"
  "scripts/progress-pulse.py|scripts/progress-pulse.py|0755"
)
